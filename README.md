...
<p align="center">
  ...
  <br>
  <em>图 3：批阅台——左侧 工作内容 / 决策裁决 / 已批阅归档，右侧展开 R1 提炼的「决策内容」（现状背景 → 可选方案 → 建议），R0 以裁决签批准、驳回或修改（会自动驱动重新派发）。</em>
</p>
...
| **03 批阅台** | 决策审批 | 左侧 工作内容 / 决策裁决 / 已批阅归档；右侧展开 R1 提炼的「决策内容」（现状背景 → 可选方案 → 建议），R0 以裁决签批准、驳回或修改 |
